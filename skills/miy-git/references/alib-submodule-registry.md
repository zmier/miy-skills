...
Snapshot: 2026-07-17, 17 top-level entries. An omitted `.gitmodules` branch means “follow the child repository's governed default/upstream”; do not guess `main` or `master` from the omission.
